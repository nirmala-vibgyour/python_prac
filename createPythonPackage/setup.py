...
setup(
  name='generatepdfInvoices',         #* Your package will have this name
  ...
  install_requires=['pandas', 'openpyxl', 'fpdf'],                 # Other 3rd-party libs that pip needs to install
  classifiers=[
