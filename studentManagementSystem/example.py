from PyQt6.QtWidgets import QApplication, QVBoxLayout, QLayout, QWidget, QGridLayout, QLabel, QLineEdit, QPushButton
import sys
...
class AgeCalculator(QWidget):
    def __init__(self):
        """ Parent class of AgeCalculator, it's __init__() is called. """
        super().__init__()
