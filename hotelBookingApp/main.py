...
secureCards = pandas.read_csv("card_security.csv", dtype=str)
...
class SecureCreditCard(CreditCard):
    def authenticate(self, given_password):
        """ self.number is inherited from the super class """
        password = secureCards.loc[secureCards["number"] == self.number, "password"].squeeze()
